...
import com.inventario.ui.StockActual;
...
public class ProductoDAO {
    ...
    public void addProductDAO(ProductoDTO productdto) {
         try{
                ...
                rs=stmt.executeQuery(query);
                if(rs.next()){
                    JOptionPane.showMessageDialog(null,"Ya se ha añadido el mismo producto");
                }else{
    ...
    public void addFunction(ProductoDTO productdto){
        try {
            ...
            if(!rs.next()){
                    ...
                    pstmt.executeUpdate();
                    JOptionPane.showMessageDialog(null, "Insertado con exito, ahora ya puede comprar el producto");
                } catch (Exception e) {
                    e.printStackTrace();
                }
    }
...
//    addPurchaseDAO
     public void addPurchaseDAO(ProductoDTO productdto){
        try {
    ...
    public void editProductDAO(ProductoDTO productdto) {
        try {
    ...
    public void sellProductDAO(ProductoDTO productDTO,String username){
        int quantity=0;
        ...
        try{
            ...
            if(productDTO.getQuantity()>quantity){
                ...
                try{
                    ...
                    JOptionPane.showMessageDialog(null,"Vendido Satisfactoriamente");
                 }catch(Exception e){
                    e.printStackTrace();
                 }
             }
    ...
    public ResultSet getSalesReportQueryResult() {
     ...
     public ResultSet getSearchProductsQueryResult(String searchTxt) {
        try {
            String query = "SELECT productcode,productname,costprice,sellingprice,brand FROM products WHERE productname LIKE '%"+searchTxt+"%' OR brand LIKE '%"+searchTxt+"%' OR productcode LIKE '%"+searchTxt+"%'";
            rs = stmt.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }

...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu(String user, String username) {
        initComponents();
        ...
        mainPanel.add("First", new Inicio());
        mainPanel.add("Second", new Productos(username));
        mainPanel.add("Third", new Clientes());
        mainPanel.add("Fourth", new Proveedores());
        mainPanel.add("Sixth", new Usuarios());
        mainPanel.add("Seventh", new Logs());
        mainPanel.add("Eight", new CambioDetalles(username));
        mainPanel.add("Ninth", new StockActual(username));
        mainPanel.add("Tenth", new ReportesVenta(username));
        mainPanel.add("Eleventh", new Compras());
        mainPanel.add("Twelvth", new AcercaDe());
    ...
    private void initComponents() {
        ...
        addProductBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/productLarge.png"))); // NOI18N
        ...
        customersBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/customerLarge.png"))); // NOI18N
        ...
        suppliersBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/supplierLarge.png"))); // NOI18N
        ...
        userBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/userLarge.png"))); // NOI18N
        ...
        userLab.setText("Usuarios");

        currentStocksBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/inventory-maintenance-icon.png"))); // NOI18N
        ...
        salesReportBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/saleLarge.png"))); // NOI18N
        ...
        salesReportLab.setText("Ventas");

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/home.png"))); // NOI18N
        ...
        purchaseBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/basket-icon.png"))); // NOI18N
        ...
        menuBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/menu.png"))); // NOI18N
        ...
        homeMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/home.png"))); // NOI18N
        homeMenuItem.setText("Inicio");
        ...
        salesMenuItem.setText("Acciones");
        ...
        changeDetailsMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/changeDetails.png"))); // NOI18N
        changeDetailsMenuItem.setText("Cambiar Detalles");
        ...
        logoutMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/logoutSmall.png"))); // NOI18N
    ...
    private void userBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userBttnMouseClicked
        /* setContentPane(new Usuarios().mainPanel);
        remove(mainPanel);
        revalidate();
        repaint(); */
        addUsersPage();

...
//        deleteLab.setVisible(false); 
    ...
    private void initComponents() {
        ...
        suppliersNameLab.setText("Nombre del Proveedor");
        ...
        btnReporteProveedores.setText("Generar Reporte");
        ...
        jTabbedPane1.addTab("Proveedores", inputPanel);

        jLabel1.setFont(new java.awt.Font("Comfortaa", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 102, 204));
        jLabel1.setText("Proveedores");

        searchTxt.setToolTipText("Buscar usando nombre, ubicacion, telefono o codigo");
    ...
    private void editBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editBttnMouseClicked
        if(table.getSelectedRow()<0){
            ...
            if(suppliersNameTxt.getText().equals("") || locationTxt.getText().equals("") || phoneTxt.getText().equals("")){
                ...
                ProveedorDTO supplierdto=new ProveedorDTO();
                ...
                new ProveedorDAO().editSupplierDAO(supplierdto);
                loadDatas();
                //table.getColumn("sid").setMaxWidth(0);
            }
        }
    ...
    private void deleteBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteBttnMouseClicked
        if(table.getSelectedRow()<0){
            ...
            new ProveedorDAO().deleteSupplierDAO(table.getValueAt(table.getSelectedRow(),0).toString());
            loadDatas();
        }
    ...
    private void addBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addBttnMouseClicked
        ...
        if(suppliersNameTxt.getText().equals("") || locationTxt.getText().equals("") || phoneTxt.getText().equals("")){
            ...
            supplierdto.setLocation(locationTxt.getText());
            supplierdto.setPhone(phoneTxt.getText());
            new ProveedorDAO().addSupplierDAO(supplierdto);
            loadDatas();
        }
    ...
    private void btnReporteProveedoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteProveedoresActionPerformed
        try {
            ...
            String path = "src\\com\\inventario\\report\\reporteProveedores.jasper";
    ...
    public void loadDatas(){
            try{
                ProveedorDAO supplierDAO=new ProveedorDAO();

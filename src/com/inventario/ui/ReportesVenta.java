...
String u;
     ...
     */
    public ReportesVenta(String user) {
        initComponents();
        u=user;
        loadDatas();
    ...
    private void initComponents() {
        ...
        productCodeLab.setText("Codigo de Producto");
        ...
        productCodeLab1.setText("Codigo Cliente");
        ...
        sellBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/saleLarge.png"))); // NOI18N
        ...
        clearBttn1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/clear.png"))); // NOI18N
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        String cus=new ProductoDAO().getProductsCustomer(Integer.parseInt(salesIdTxt.getText()));
        supplierInfoLab.setText("Vendido a "+cus);
        String soldDate=new ProductoDAO().getSoldDate(Integer.parseInt(salesIdTxt.getText()));
    ...
    private void deleteBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteBttnMouseClicked
        if(table.getSelectedRow()<0){
            ...
            new ProductoDAO().deleteSalesDAO(String.valueOf(table.getValueAt(table.getSelectedRow(),0)));
            new ProductoDAO().editSoldStock(String.valueOf(table.getValueAt(table.getSelectedRow(),1)),quantity);
            loadDatas();
        }
    ...
    private void sellBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sellBttnMouseClicked
        if(dateChooser.getDate()==null || quantityTxt.getText().equals("") || customerCodeTxt.getText().equals("") ){
            ...
            try{
                ResultSet rs=new ClienteDAO().getCustomersName(customerCodeTxt.getText());
                if(rs.next()){
                    ...
                    new ProductoDAO().sellProductDAO(productdto,u);
                    loadDatas();
                }else{
                    JOptionPane.showMessageDialog(null, "Escribe un codigo de cliente valido!");
                }
            }catch(Exception e){
                e.printStackTrace();
            }
    ...
    private void customerCodeTxtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_customerCodeTxtKeyReleased
        ...
        try{
            ResultSet rs=new ClienteDAO().getCustomersName(customerCodeTxt.getText());
            if(rs.next()){
                customerNameLab.setText("Nombre: "+rs.getString("fullname") + " | Ubicacion: "+rs.getString("location"));
            }else{
                customerNameLab.setText("No esta asociado con ningun cliente!");
            }
        }catch(Exception e){
            e.printStackTrace();
        }
    ...
    private void productCodeTxtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_productCodeTxtKeyReleased
        ...
        try{
            ResultSet rs=new ClienteDAO().getProductsName(productCodeTxt.getText());
            if(rs.next()){
                productNameLab.setText("Nombre: "+rs.getString("productname")+" | Cantidad Disponible: "+rs.getInt("quantity"));
                Double sellingPrice=new ProductoDAO().getProductSellingPrice(productCodeTxt.getText());
...
try {
            ...
            String path = "src\\com\\inventario\\report\\reporteVentas.jasper";

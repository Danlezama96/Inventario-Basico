 ...
 * @author Danlez
 */
public class CambioDetalles extends javax.swing.JPanel {

    /**
     * Creates new form CambioDetalles
     */

    String user;
    public CambioDetalles(String userSelect) {
        initComponents();
        user = userSelect;
        ...
        ResultSet rs = new UsuarioDAO().getUser(user);
        try {
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        passwordLab.setText("Contraseña Anterior:");

        locationLab.setText("Ubicacion:");

        fullNameLab.setText("Nombre Completo:");
        ...
        passwordLab1.setText("Categoria");
        ...
        passwordLab3.setText("Contraseña Nueva");
            ...
            .addGroup(inputPanelLayout.createSequentialGroup()
                ...
                .addGroup(inputPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(inputPanelLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(inputPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(fullNameTxt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 208, Short.MAX_VALUE)
        ...
        jTabbedPane1.addTab("Detalle del Perfil", inputPanel);

        editProfileBttn.setText("Editar Perfil");
    ...
    private void editBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editBttnMouseClicked
        if (fullNameTxt.getText().equals("") || locationTxt.getText().equals("") || phoneTxt.getText().equals("") || usernameTxt.getText().equals("") || passwordTxt.getText().equals("") || newPasswordTxt.getText().equals("")) {
            ...
            String encryptPass=new Usuarios().encryptPassword(passwordTxt.getText());
                ResultSet rs = new UsuarioDAO().getPassword(usernameTxt.getText(),encryptPass);
                try {
                    if(rs.next()) {
                        new UsuarioDAO().changePassword(usernameTxt.getText(),newPasswordTxt.getText());
                    }else{

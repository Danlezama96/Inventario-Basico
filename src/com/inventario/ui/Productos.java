...
//        suppliersName();    
    ...
    private void initComponents() {
        ...
        priceLab1.setText("Precio Venta");

        brandLab.setText("Marca");
        ...
        editBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/edit item.png"))); // NOI18N
        ...
        btnReporteProductos.setText("Generar Reporte");
...
static String productCode;
    ...
    private void deleteBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteBttnMouseClicked
        if(table.getSelectedRow()<0){
            ...
            new ProductoDAO().deleteProductDAO(((String)table.getValueAt(table.getSelectedRow(),0)));
            loadDatas();
        }
    ...
    private void editBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editBttnMouseClicked
        if(table.getSelectedRow()<0){
            ...
            if(productNameTxt.getText().equals("") || costPriceTxt.getText().equals("") || sellingPriceTxt.getText().equals("") || brandTxt.getText().equals("")){
                ...
                new ProductoDAO().editProductDAO(productdto);

                /*
                if(productCode.equals(productCodeTxt.getText())){
                    new ProductoDAO().editStock1(productdto,quantity,productCode);
                }else{
                    new ProductoDAO().editStock2(productdto,quantity,productCode);
                }
                new ProductoDAO().editProductDAO(productdto);
                */
            }
    ...
    private void addProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addProductMouseClicked
        ...
        if( productNameTxt.getText().equals("") || costPriceTxt.getText().equals("") || sellingPriceTxt.getText().equals("") || brandTxt.getText().equals("")){
            ...
            productdto.setBrand((brandTxt.getText()));
            productdto.setUserId(userId);
            new ProductoDAO().addProductDAO(productdto);
            loadDatas();
        }
    ...
    private void btnReporteProductosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteProductosActionPerformed
        try {
            ...
            String path = "src\\com\\inventario\\report\\reporteProductos.jasper";

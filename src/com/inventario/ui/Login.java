...
public class Login extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/loginMember.png"))); // NOI18N

        usernameLab.setText("Usuario");
        ...
        loginBttn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/inventario/ui/images/logout-icon.png"))); // NOI18N
    ...
    private void loginBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBttnMouseClicked
        ...
        if(new ConexionBD().checkLogin(username,password,user)==true){
            dispose();
            new Menu(user,username);
        }else{
            JOptionPane.showMessageDialog(null, "Nombre o contraseña invalidos");
        }
